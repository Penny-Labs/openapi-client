# @penny-labs/openapi-penny-client@0.5.0
...
*RuntimeApi* | [**completeRuntimeConnectionRelink**](docs/RuntimeApi.md#completeruntimeconnectionrelink) | **POST** /v1/runtime/connections/{connectionID}/relink | Complete a managed connection repair
*RuntimeApi* | [**connectRuntimeManagedConnection**](docs/RuntimeApi.md#connectruntimemanagedconnection) | **POST** /v1/runtime/connections/link | Complete a browser-safe managed Plaid Link session
*RuntimeApi* | [**createRuntimeBillingPortal**](docs/RuntimeApi.md#createruntimebillingportal) | **POST** /v1/runtime/billing/portal | Create a Stripe test-mode billing portal session for an administrator
*RuntimeApi* | [**createRuntimeConnectionLinkToken**](docs/RuntimeApi.md#createruntimeconnectionlinktoken) | **POST** /v1/runtime/connections/link-token | Create a browser-safe managed Plaid Link session
*RuntimeApi* | [**createRuntimeConnectionRelinkToken**](docs/RuntimeApi.md#createruntimeconnectionrelinktoken) | **POST** /v1/runtime/connections/{connectionID}/relink-token | Create an update-mode Link token for a managed connection
...
*RuntimeApi* | [**revokeRuntimeManagedConnection**](docs/RuntimeApi.md#revokeruntimemanagedconnection) | **DELETE** /v1/runtime/connections/{connectionID} | Revoke a managed provider connection without deleting local finance history
...
- [ManagedConnectionLinkResult](docs/ManagedConnectionLinkResult.md)
...
- [ManagedLinkAccount](docs/ManagedLinkAccount.md)
- [ManagedLinkConnectRequest](docs/ManagedLinkConnectRequest.md)
- [ManagedLinkInstitution](docs/ManagedLinkInstitution.md)
- [ManagedLinkMetadata](docs/ManagedLinkMetadata.md)
- [ManagedLinkTokenResponse](docs/ManagedLinkTokenResponse.md)
