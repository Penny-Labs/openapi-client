...
```typescript
import type { TransactionRulePatchRequest } from '@penny-labs/openapi-penny-client'
...
const example = {
  ...
  "conditionTree": null,
  "actions": null,
} satisfies TransactionRulePatchRequest
...
const exampleParsed = JSON.parse(exampleJSON) as TransactionRulePatchRequest
